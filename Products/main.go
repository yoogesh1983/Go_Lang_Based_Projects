...
func main() {
	...
	// filename regex: {filename:[a-zA-Z]+\\.[a-z]{3}} i.e. it's name should be of a-z and after the dot(.), the extenssion name must of 3 letters which should not be a number
